...
import { getSitemapAnalysis, type SitemapAnalysis } from '@/lib/sitemap'
...
export default async function DashboardPage() {
  ...
  if (data) {
    try {
      ...
      // Sitemap analysis failed — tab will show empty state
    }
  }
      ...
      <>
          ...
          <Tabs defaultValue="overview">
            ...
            <TabsContent value="optimization">
              {sitemapAnalysis ? (
                <OptimizationPriorityTable
                  communities={sitemapAnalysis.communities}
                  untrackedPages={sitemapAnalysis.untrackedPages}
                ...
                <SectionCard title="Optimization Priority">
                  <p className="text-sm text-[#8aadb8] py-4 text-center">Sitemap analysis unavailable.</p>
                </SectionCard>
              )}
            </TabsContent>
          </Tabs>
